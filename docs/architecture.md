...
**Status: Phase 0 contracts and Phase 1A Capability Profiler v2 are implemented.** The local benchmark workload, model registry v2 records, adaptive router core, runtime model-selection integration, and router UI do not exist yet; the active v0.6 model registry/router still power actual model recommendations today. See `docs/roadmap.md` for the remaining phases.
